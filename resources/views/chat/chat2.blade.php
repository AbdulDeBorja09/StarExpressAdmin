            ...
            <div class="panel absolute z-10 hidden w-full max-w-xs flex-none space-y-4 overflow-hidden p-4 xl:relative xl:block xl:h-full"
                    ...
                    <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                        <button type="button"
                            ...
                            <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 opacity-70">
                            ...
                            <li>
                                <a href="javascript:;" @click="toggle">
                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                        ...
                                        class="h-4.5 w-4.5 shrink-0 ltr:mr-1 rtl:ml-1">
                ...
                <div class="!mt-0">
                    <div
                        ...
                        <template x-for="contact in contactList" :key="contact.userId">
                            <button type="button"
                                ...
                                :class="{'bg-gray-100 dark:bg-[#050b14] dark:text-primary text-primary': selectedConversation.userId === contact.userId}"
                                @click="selectedConversation = contact">
                                <div class="flex-1">
                                    <div class="flex items-center">
                                    ...
                                    <button type="button"
                                        ...
                                        <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                            ...
                                            <path opacity="0.5" d="M13.5 11L17 11" stroke="currentColor"
                                                stroke-width="1.5" stroke-linecap="round"></path>
                                            <path opacity="0.5" d="M7 8L9 8" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round"></path>
                                            <path opacity="0.5" d="M7 11L9 11" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round"></path>
                                            <path opacity="0.5"
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('chat', () => ({
            contactList: @json($contactList), // Replace with dynamic data
            selectedConversation: null,
            newMessage: '',
            sendMessage() {
                axios.post('/send-message', {
                    conversation_id: this.selectedConversation.id,
                    to_user_id: this.selectedConversation.userId,
            ...
            init() {
                Echo.channel('conversation.' + this.selectedConversation.id)
                    .listen('MessageSent', (event) => {
                        this.selectedConversation.messages.push(event.message);
                    });
            }
        }));
    });

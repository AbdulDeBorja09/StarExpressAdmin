...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <div x-data="contacts">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <h2 class="text-xl">All Employees</h2>
            <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                <div class="flex gap-3">
                    <div>
                        <a type="button" class="btn btn-primary" @click="editUser" style="cursor: pointer">
                ...
                <div class="relative">
                    <input type="text" placeholder="Search Contacts" class="peer form-input py-2 ltr:pr-11 rtl:pl-11"
                ...
                <template x-for="contact in filterdContactsList" :key="contact.id">
                    <div class="relative overflow-hidden rounded-md bg-white text-center shadow dark:bg-[#1c232f]">
                        ...
                        <div class="absolute bottom-0 mt-6 flex w-full gap-4 p-6 ltr:left-0 rtl:right-0">
                            ...
                            <button type="button" class="btn btn-outline-danger w-1/2" @click="deleteUser(contact)">
                                Delete
                            </button>
                        </div>
                    </div>

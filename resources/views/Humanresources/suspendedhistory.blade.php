...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <ol class="flex font-semibold text-gray-500 dark:text-white-dark">
        ...
        <li class="before:px-1.5 before:content-['/']"><a>Suspended History</a></li>
        <li class="before:px-1.5 before:content-['/']">
            <a href="javascript:;"
                class="text-black hover:text-black/70 dark:text-white-light dark:hover:text-white-light/70">{{$label}}</a>
        </li>
    </ol>
                ...
                <table class="orders-table table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($item->updated_at)->format('g:i A') }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>

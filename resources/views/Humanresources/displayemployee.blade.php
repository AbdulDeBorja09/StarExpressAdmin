            ...
            <div class="px-0">
                <div class=" md:top-5 ltr:md:left-5 rtl:md:right-5">
                    <div class="mb-5 flex items-center justify-between gap-4">
                        <a href="{{route('addEmployees')}}" class="btn btn-primary gap-2">
                    ...
                    <div class="relative -mt-2 px-6 pb-24">
                        ...
                        <div class="mt-6 grid grid-cols-1 gap-4 ltr:text-left rtl:text-right">
                            ...
                            <div class="flex items-center">
                                <div class="flex-none ltr:mr-2 rtl:ml-2">Employee Id:</div>
                                <div class="truncate text-white-dark">{{ $item->employee_id }}</div>
                            </div>
                            <div class="flex items-center">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="text-white-dark">{{ $item->contact }}</div>
                            </div>
                            <div class="flex items-center">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="text-white-dark">{{ $item->address }}</div>
                            </div>

                        </div>
                    </div>
                    <div class="absolute bottom-0 mt-6 flex w-full gap-4 p-6 ltr:left-0 rtl:right-0">
                        <a href="{{url('/Employees/Edit/'. $item->id)}}" type="button"

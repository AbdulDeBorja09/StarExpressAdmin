...
<div class="animate__animated p-6" :class="[$store.app.animation]">
    <ol class="flex font-semibold text-gray-500 dark:text-white-dark">
        ...
        <li class="before:px-1.5 before:content-['/']">
            <a href="javascript:;"
                class="text-black hover:text-black/70 dark:text-white-light dark:hover:text-white-light/70">New
            </a>
        </li>
    </ol>
        ...
        <div class="panel">
            <div>
                ...
                <form action="{{route('createnewreport')}}" class="mt-5" method="POST">
                    @csrf
                    <label for="tripid" class="mb-2 w-1/3 ltr:mr-2 rtl:ml-2" style="font-size:15px">Created By:
                    </label>
                    <input class="form-input flex-1 mb-2" type="text"
                        value="{{Auth::user()->lname}}, {{Auth::user()->fname}}">
                    <label for="tripid" class="mb-2 w-1/3 ltr:mr-2 rtl:ml-2" style="font-size:15px">Report Type:</label>
                    <select class="form-input flex-1 mb-2" name="type" id="truck">
                        <option value="expenses" selected>Expenses</option>
                        <option value="income">Income</option>
                    </select>
                    <label for="driver" class="mb-2 w-1/3 ltr:mr-2 rtl:ml-2" style="font-size:15px">Reference:</label>
                    <input class="form-input flex-1 mb-2" type="text" name="reference">
                    <label for="driver" class="mb-2 w-1/3 ltr:mr-2 rtl:ml-2" style="font-size:15px">Amount:</label>

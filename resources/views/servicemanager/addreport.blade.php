            ...
            <div>
                ...
                <form action="{{route('createnewreport')}}" class="mt-5" method="POST">
                    ...
                    <form action="{{route('requestreport')}}" class="mt-5" method="POST">
                        ...
                        <label for="type" class="mb-2 w-1/3 ltr:mr-2 rtl:ml-2" style="font-size:15px">Report
                            Type:</label>
                        ...
                        <label for="ref" class="mb-2 w-1/3 ltr:mr-2 rtl:ml-2" style="font-size:15px">Reference:</label>
                        <input class="form-input flex-1 mb-2" id="ref" type="text" name="reference">

                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="flex justify-around border-[#ebedf2] dark:border-[#191e3a]">
                                ...
                                <form action="{{route('deletetruck')}}" method="POST" id="delete-form-{{ $item->id }}">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$item->id}}}">
                                    <button type="button" x-tooltip="Delete"
                                        ...
                                        .then((result) => {
                                            if (result.value) {
                                                ...
                                                swalWithBootstrapButtons.fire({
                                                    title: 'Deleted!',
                                                    html: '<div class="text-center mt-3">Truck Has Been Deleted.</div>', 
                                                    icon: 'success',
                                                ...
                                                swalWithBootstrapButtons.fire({
                                                    title: 'Cancelled',
                                                    html: '<div class="text-center mt-3">Your Truck Is Safe.</div>', 
                                                    icon: 'error',
                                                    confirmButtonText: 'OK', 
                                                });
                                            }

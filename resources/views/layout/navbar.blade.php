<header class="z-40" :class="{'dark' : $store.app.semidark && $store.app.menu === 'horizontal'}" wire:ignore>
    <div class="shadow-sm">
        <div class="relative flex w-full items-center px-5 py-2.5 bg-white dark:bg-[#0e1726] ">
                    ...
                    <a href="javascript:;" class="group relative" @click="toggle()">
                        <span>
                            ...
                            <img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                src=" {{ Storage::url(session('image')) }}" alt="User Avatar">
                            @else
                            <img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                            ...
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    ...
                                    <img class="h-10 w-10 rounded-md object-cover"
                                        src=" {{ Storage::url(session('image')) }}" alt="User image">
                                    @else

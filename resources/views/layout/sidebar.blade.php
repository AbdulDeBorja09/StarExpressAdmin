    ...
    <nav
        ...
        <div class="h-full bg-white dark:bg-[#0e1726]">
            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold"
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        :class="{'active' : activeDropdown === 'accountanthistory'}"
                        @click="activeDropdown === 'accountanthistory' ? activeDropdown = null : activeDropdown = 'accountanthistory'">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'accountanthistory'}">
                            <svg width="16" height="16" viewbox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <ul x-show="activeDropdown === 'accountanthistory'" x-collapse="" class="sub-menu text-gray-500">
                        <li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-show="activeDropdown === 'orders'" x-collapse="" class="sub-menu text-gray-500">
                        <li>
                            ...
                            {{-- <a href="{{route('outfordelivery')}}"
                                class="{{ Route::currentRouteName() == 'outfordelivery' ? 'active' : '' }}">History
                            </a> --}}
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-show="activeDropdown === 'dallowance'" x-collapse="" class="sub-menu text-gray-500"
                        style="height: 0px; overflow: hidden; display: none;" hidden="">
                        <li>
                            <a href="{{route('trucklist')}}">Request</a>
                        </li>
                        <li>
                ...
                <li class="menu nav-item">
                    <button type="button" class="nav-link group"
                        :class="{'active' : activeDropdown === 'servicehistory'}"
                        @click="activeDropdown === 'servicehistory' ? activeDropdown = null : activeDropdown = 'servicehistory'">
                        <div class="flex items-center">
                            <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'servicehistory'}">
                            <svg width="16" height="16" viewbox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <ul x-show="activeDropdown === 'servicehistory'" x-collapse="" class="sub-menu text-gray-500">
                        <li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-show="activeDropdown === 'sreport'" x-collapse="" class="sub-menu text-gray-500"
                        style="height: 0px; overflow: hidden; display: none;" hidden="">
                        <li>
                            <a href="{{route('trucklist')}}">Create</a>
                        </li>
                        <li>
                            <a href="{{route('trucklist')}}">All Reports</a>
                        </li>
